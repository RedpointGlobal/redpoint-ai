/**
 * Type helpers for the DRH (Data Readiness Hub) OP-ServicesAPI.
 *
 * Primary usage: import schema types directly for typing API responses.
 *   import type { components } from "../client/drh-types.js";
 *   type MyResponse = components["schemas"]["SomeResponse"];
 *
 ...
 *
 * Mirrors packages/mcp-rpi/src/client/rpi-types.ts (intentional copy).
 */
import type { paths, components, operations } from "./drh-api.generated.js";
